    ...
    set_fieldname_select: function(frm) {
        ...
        if (doc.doc_type) {
            frappe.model.with_doctype(doc.doc_type, function() {
                ...
                frappe.meta.get_docfield("Web Form Field Advanced", "fieldname", frm.doc.name).options = [""].concat(fields);
                //frappe.meta.get_docfield("Web Form Advanced", "amount_field", frm.doc.name).options = [""].concat(currency_fields);
